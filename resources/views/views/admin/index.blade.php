...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <a href="/admin/api" class="mt-4 inline-block text-blue-400 hover:text-blue-300">Edit →</a>
        </div>
        ...
        <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <dl class="space-y-2">
                ...
                <div class="flex justify-between">
                    ...
                    <dd>{{ $settings->updated_at ? $settings->updated_at->diffForHumans() : 'Never' }}</dd>
                </div>
            </dl>
        </div>
    </div>
    ...
    <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
        <h2 class="text-xl font-semibold mb-4 text-gray-300">Users</h2>
        <p class="text-gray-400">User management will appear here.</p>
    </div>
