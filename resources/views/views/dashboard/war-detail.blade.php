...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <h3 class="text-gray-400 text-sm uppercase tracking-wide mb-2">Start Date</h3>
            <p class="text-xl">{{ $war->start_date ? $war->start_date->format('d M Y') : 'Unknown' }}</p>
        </div>

        <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <h3 class="text-gray-400 text-sm uppercase tracking-wide mb-2">End Date</h3>
            <p class="text-xl">{{ $war->end_date ? $war->end_date->format('d M Y') : 'Unknown' }}</p>
        </div>
    </div>
