...
<div class="space-y-8">
    ...
    <div class="bg-gray-800 rounded-lg border border-gray-700">
        <div class="p-4 border-b border-gray-700">
            <h2 class="text-xl font-semibold text-purple-400">Actieve Wars</h2>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead>
                    <tr class="text-left text-gray-400 bg-gray-700/50">
                        <th class="p-4">Tegenstander</th>
                ...
                <tbody class="divide-y divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-700/30">
                        <td class="p-4">
                            <span class="font-semibold">{{ $war->opponent_faction_name ?? 'Onbekend' }}</span>
    ...
    <div class="bg-gray-800 rounded-lg border border-gray-700">
        <div class="p-4 border-b border-gray-700">
            <h2 class="text-xl font-semibold text-gray-300">Afgelopen Wars</h2>
        </div>
        
        @if($pastWars->isEmpty())
            <div class="p-8 text-center text-gray-400">
                Geen afgelopen wars gevonden.
            </div>
        @else
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-700/30">
                        ...
                        <td class="p-4">
                            @if($war->status === 'won')
                                <span class="px-2 py-1 rounded text-xs bg-green-900 text-green-400">Gewonnen</span>
                            @elseif($war->status === 'lost')
                                <span class="px-2 py-1 rounded text-xs bg-red-900 text-red-400">Verloren</span>
                            @else
